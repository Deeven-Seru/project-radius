...
- **Average Processing Latency**: **2.3261 ms**
- **Standard Deviation (Jitter)**: **2.0348 ms**
- **95th Percentile Latency (p95)**: **2.5429 ms**
- **99th Percentile Latency (p99)**: **2.8121 ms**
- **99.9th Percentile Latency (p999)**: **5.1369 ms**
- **Maximum Latency Peak**: **145.3809 ms**

The log-scale latency distribution histogram has been saved to [data/comparisons/soak_test_histogram.png](file:///home/deeven/project-radius/data/comparisons/soak_test_histogram.png).
...
- **Temporal $R^2$ Accuracy under noise**: **88.4892%**
- **Accuracy loss due to noise**: **10.2084%** (compared to the noiseless reference of 98.6976%)
...
---
*Report generated on 2026-07-01 20:45:35 UTC by the Antigravity stress-agent.*
